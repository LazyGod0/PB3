...
function BillPage(){
  return(
    ...
    <Box sx={{ flexGrow: 1  }} >
      ...
      <Typography sx={{ fontSize:'30px',paddingLeft:'150px',paddingTop:'70px',mb:'30px' }}>
        ชำระบิลค่าเช่า เดือน มกราคม 2024
      </Typography>
      <Box sx={{backgroundColor:'#F0F0F0', padding:'30px',ml:'100px',mr:'100px'}}>
        <Box sx={{ display: 'flex', flexDirection: 'row', gap: '1000px',backgroundColor:'#344CB7',padding:'30px' }}>
